.class public Lcom/jstun/core/attribute/SourceAddress;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 18
    const-string v0, "com.jstun.core.attribute.SourceAddress"

    invoke-static {v0}, Ljava/util/logging/Logger;->getLogger(Ljava/lang/String;)Ljava/util/logging/Logger;

    move-result-object v0

    sput-object v0, Lcom/jstun/core/attribute/SourceAddress;->logger:Ljava/util/logging/Logger;
...
.method public static parse([B)Lcom/jstun/core/attribute/MessageAttribute;
    ...
    .prologue
    .line 24
    new-instance v0, Lcom/jstun/core/attribute/SourceAddress;

    invoke-direct {v0}, Lcom/jstun/core/attribute/SourceAddress;-><init>()V

    .line 25
    .local v0, "sa":Lcom/jstun/core/attribute/SourceAddress;
    ...
    .line 26
    sget-object v1, Lcom/jstun/core/attribute/SourceAddress;->logger:Ljava/util/logging/Logger;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Message Attribute: Source Address parsed: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    invoke-virtual {v0}, Lcom/jstun/core/attribute/SourceAddress;->toString()Ljava/lang/String;
